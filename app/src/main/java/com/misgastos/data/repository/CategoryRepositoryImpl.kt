...
import com.misgastos.domain.repository.CategoryDeletionResult
import com.misgastos.domain.repository.CategoryRepository
import com.misgastos.utils.DEFAULT_CATEGORY_PRESETS
...
class CategoryRepositoryImpl @Inject constructor(
    ...
    override fun observeCategories(includeInactive: Boolean): Flow<List<com.misgastos.domain.model.Category>> {
